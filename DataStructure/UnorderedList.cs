    ...
    public class UnorderedList
    {
        ...
        public void List()
        {
            try
            {
                ...
                string text = File.ReadAllText(@"C:\Users\Bridgelabz\Desktop\file.txt");
                ...
                if(r == 1)
                {
                    ...
                    if (n == 1)
                    {
                        ...
                        File.WriteAllText(@"C:\Users\Bridgelabz\Desktop\file.txt", search);
                    }
                    else
                        return;
                }
                ...
                {
                    Console.WriteLine("Do you want to add " + search + " word from the list press 1 for delete nor 2 for ignore");
